...
const Reasoning: FC<ReasoningStepProps> = ({ index, stepTitle }) => (
  <div className="flex items-center gap-2 text-secondary">
    <div className="flex h-[20px] items-center rounded-md bg-badge p-2">
      <p className="text-xs text-badge-text">STEP {index + 1}</p>
    </div>
...
const ToolComponent = memo(({ tools }: ToolCallProps) => (
  <div className="cursor-default rounded-full bg-badge px-2 py-1.5 text-xs">
    <p className="font-dmmono uppercase text-badge-text">{tools.tool_name}</p>
  </div>
))
