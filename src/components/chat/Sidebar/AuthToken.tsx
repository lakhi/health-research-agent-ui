      ...
      {isEditing ? (
        <div className="flex w-full items-center gap-1">
          <input
            ...
            className="flex h-9 w-full items-center text-ellipsis rounded-xl border border-primary/15 bg-badge p-3 text-xs font-medium text-badge-text placeholder:text-badge-text/50"
            autoFocus
          />
          <Button
            variant="ghost"
